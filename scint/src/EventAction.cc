...
void EventAction::EndOfEventAction(const G4Event* evt)
{
      ...
      analysisManager->FillH3(0,X_coor,Y_coor,Z_coor);
      analysisManager->FillH2(0,angle_Phi,angle_Theta);
      analysisManager->FillH2(1,angle_Theta,angle_Phi);
      //analysisManager->FillH3(1,X_coor,Y_coor,Z_coor);
      ...
      analysisManager->FillNtupleDColumn(0,Radius);
      analysisManager->FillNtupleDColumn(1,angle_Theta);
      analysisManager->FillNtupleDColumn(2,angle_Phi);
      analysisManager->FillNtupleDColumn(3,X_coor);
      analysisManager->FillNtupleDColumn(4,Y_coor);
      analysisManager->FillNtupleDColumn(5,Z_coor);
